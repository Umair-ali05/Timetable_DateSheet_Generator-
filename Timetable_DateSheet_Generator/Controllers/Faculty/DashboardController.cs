...
{
    [Route("Faculty/FacultyDashboard/[action]")]
    ...
    public class FacultyDashboardController : Controller
    {
        ...
        public FacultyDashboardController(Timetable_DateSheet_Context timetable_DateSheet_Context,
        ...
        public async Task<IActionResult> view(string w_Form, string _Action, string Message, string MessageType)
        {
            try
            {
                ...
                if (faculty != null)
                {
                    ViewBag.Institute = faculty.Department.Institute.InstituteName;
                    ViewBag.Department = faculty.Department.DepartmentName;
                }
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (passResult.Succeeded)
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            var returnUrl = "~/Faculty/FacultyDashboard/View?w_Form='pass'&_Action='true'&Message='Password changed successfully.'&MessageType='success'";
